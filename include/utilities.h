...
#endif /* not defined AES_BLOCK_SIZE */
...
uint8_t compareDigests(const uint8_t const *digestOne, const uint8_t const *digestTwo, const uint32_t len);
int32_t AES_CTR_Crypt(mbedtls_aes_context*, size_t, uint8_t nonce_counter[16], uint8_t*, uint8_t*);
