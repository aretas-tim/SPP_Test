...
#include "stm32l4xx_hal_usart.h"     /* STM32F USART control functions.           */
#include "stm32l4xx_hal_rcc.h"       /* STM32F Clock control functions.           */
#include "stm32l4xx_ll_exti.h"      /* STM32F Ext interrupt definitions.         */
//#include "stm32l4xx_syscfg.h"    /* STM32F system config definitions.         */
...
#define HCITR_RESET_GPIO_AHB_BIT       (DEF_CONCAT2(RCC_AHB1Periph_GPIO, HCITR_RESET_PORT))
   ...
   #define HCITR_CTS_IRQ_LINE          LL_EXTI_LINE_0
