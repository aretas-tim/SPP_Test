...
UART_HandleTypeDef huart_debug; //the uart to handle debug info. UART5
UART_HandleTypeDef huart_console; //the uart handle for the console uart USART3. Added by Tim
//------
